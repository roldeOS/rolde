...
| ◐ | **RolDe Courier** | The clinical postal system (GREENLIT 2026-07-02) — **C1 ✅ complete: read receipts + New→Seen + "N new" + the Seen-by thread (who read what, when)**; C2 address book/settings · C3 outbound email + live tracking · C4 clinic↔clinic · C5 chase/kill-switch ▢ |
