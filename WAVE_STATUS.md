...
| ▢ | **Scribe T3–T4** — T3 Caretaker Settings→Templates card + intake governance + clinic-named colour legends (approved) → T4 patient-facing intake/consent + payment hook + Phase-B form steals |
