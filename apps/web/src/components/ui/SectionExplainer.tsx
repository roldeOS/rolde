  ...
  return (
    <span className="relative inline-flex">
      <button
        ...
        className="relative z-10 inline-flex size-5 cursor-help items-center justify-center rounded-md bg-card text-muted-foreground shadow-sm outline-none transition-colors before:absolute before:-inset-2.5 before:content-[''] hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/40"
      >
