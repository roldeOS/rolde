...
export const PLATFORM_TEMPLATES: EmailTemplateSeed[] = [
  {
    ...
    category: "auth",
    subject: "Reset your RolDe OS password",
    preheader: "Set a new password for your RolDe OS account.",
    headline: "Reset your password",
    paragraphs: [
      "Hi {{name}},",
      "We got a request to set a new password for your RolDe OS account. Tap the button below and you’ll be choosing a new one in seconds.",
    ],
  ...
  },
  {
    ...
    category: "auth",
    subject: "You’re invited to {{clinic}} on RolDe OS",
    preheader: "Set your password to join {{clinic}} on RolDe OS.",
